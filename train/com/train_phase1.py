...
Module-level definitions (importable without side effects):
    TrajForecaster        Phase 1 GRU model class
    persistence, linear_extrap, constant_velocity     closed-form baselines
    HISTORY, HORIZON, SEED, GRU_HIDDEN, ...            constants
All heavy execution (data load, training, eval, plotting) lives inside main()
so `from train_phase1 import TrajForecaster` does not trigger a training run.
"""
...
# ---------------------------------------------------------------------------
# Paths (module level — no os.makedirs here; deferred to main())
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Hyperparameters (module level — all in one place, easy to sweep)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Closed-form baselines (module level — pure functions, importable)
# ---------------------------------------------------------------------------
